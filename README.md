...
- [Chord generator](#chord-generator)
  - [Introduction](#introduction)
  - [Music Theory in Java](#music-theory-in-java)
    - [Note names for newbies](#note-names-for-newbies)
    - [Scale formula](#scale-formula)
    - [Octave, modulo 12 and note indexes](#octave-modulo-12-and-note-indexes)
    - [Intervals](#intervals)
    - [Inverted chords](#inverted-chords)
    - [Naming chords](#naming-chords)
- [How to generate chords](#how-to-generate-chords)
  - [Basic principle](#basic-principle)
  - [Why depth first recursion](#why-depth-first-recursion)
  - [Sanity check during recursion](#sanity-check-during-recursion)
- [Scale URL](#scale-url)
- [How to display your GraphML in yEd](#how-to-display-your-graphml-in-yed)
